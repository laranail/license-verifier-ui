...
The install command generates a thin, **owned** Blade license UI into your app — under your own
namespace and path — that extends this package. Pick a theme: **tailwind, bootstrap, alpine,
unstyled, custom**.
